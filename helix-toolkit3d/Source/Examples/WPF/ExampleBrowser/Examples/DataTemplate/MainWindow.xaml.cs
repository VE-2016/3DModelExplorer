...
namespace Viewer3D
{
    ...
    ///     Interaction logic for MainWindow.xaml
    /// </summary>
    [Example(null, "Creating Visual3Ds.")]
    public partial class MainWindow
    {
        ...
        {
            Materials.Orange
            var c = DataProject.Form1.GetData();
            ...
            atomsTable = DataProject.Form1.LoadAtoms();
        ...
        private void Lb_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            var c = DataProject.Form1.GetData(file);
        ...
        private void LoadFromXml(string file)
        {
            ...
            var c = DataProject.Form1.GetDataEx(file);
        ...
        private void Lb2_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            var(content,  c) = DataProject.Form1.GetRawData(name);
        ...
        private void Button_PreviewMouseLeftButtonDown_3(object sender, RoutedEventArgs e)
        {
            AutoComplete autos = DataProject.Form1.Autocomplete(tbSearch.Text);
        ...
        private void lvModel2_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            btnSaveAsXml.Content = "Save as .XML" + " - " + Path.GetFileName(file);

            this.Title = "3D Model Expolorer  -  " + Path.GetFileName(file);
        ...
        private void btnSaveAsXml_Click(object sender, RoutedEventArgs e)
        {
            ...
            string s = DataProject.Serializer.Serialize<Compound>(compound);
